...
def generate_launch_description():
    package_share = get_package_share_directory("metro_localization")
    ...
    return LaunchDescription(
        [
            ...
            # Both nodes contain demo-world constants. Keep them opt-in until
            # tunnel chainage and ground truth are configured for this world.
            DeclareLaunchArgument("run_evaluator", default_value="false"),
            DeclareLaunchArgument("run_semantic_mapper", default_value="false"),
            Node(
