...
Runs one shared YOLO model against XJ1-XJ4 and Pitch, then evaluates whether
real detections cover all ten simulation reference sites.
...
for required_file in "${MODEL_PATH}" "${VENV_DIR}/bin/python"; do
